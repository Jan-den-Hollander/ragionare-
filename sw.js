/*
  ...
  Redeneerspiegel — service worker: maakt installeren en offline gebruik mogelijk.
  Ophogen van CACHE (bijv. redeneerspiegel-v2) dwingt een volledige verversing af.
*/
const CACHE = 'redeneerspiegel-v1';
